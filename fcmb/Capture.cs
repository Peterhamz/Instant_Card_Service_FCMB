...
namespace fcmb
{
    internal class Capture : ISampleGrabberCB, IDisposable
    {
        ...
        public Capture(int iDeviceNum, int iWidth, int iHeight, short iBPP, System.Windows.Forms.PictureBox picBox)
        {
            DsDevice[] capDevices;
            ...
            try
            {
                ...
                SetupGraph(capDevices[iDeviceNum], iWidth, iHeight, iBPP, picBox);
        ...
        private void SetupGraph(DsDevice dev, int iWidth, int iHeight, short iBPP, System.Windows.Forms.PictureBox picBox)
        {
            int hr;
